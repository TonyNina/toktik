  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
       ...
       const SizedBox( height: 20),
       _CustomIconButton( value: video.views, iconData: Icons.message_outlined),
       //Todo: En caso no se puedan usar los metodos de las dependencias, mejor instalar el paquete en la TERMINAL  
        SpinPerfect(
          infinite: true,
